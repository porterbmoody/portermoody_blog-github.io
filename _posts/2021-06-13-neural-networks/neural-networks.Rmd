...
A parial derivative of the Loss function must computed with respect to each weight. This means more weights amount to a much heavier computational footprint.